...
<template>
  <main>
    <section>
      <div class="relative grid w-full bgcompany h-96 lg:h-[32rem] place-items-center">
        <div class="flex flex-col items-center mx-auto text-center">
          <h1 class="text-4xl font-semibold text-white uppercase md:text-6xl">
            Welcome to Crytech
          </h1>

          <p class="mt-6 text-lg leading-5 text-white">Where Technology Meets Tomorrow.</p>

          <a href="#about" class="mt-8 cursor-pointer animate-bounce" @click.prevent="smoothScroll">
            <svg
              width="53"
              height="53"
              viewBox="0 0 53 53"
      ...
      <svg class="fill-gray" viewBox="0 0 1440 57" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="lg:flex lg:items-center lg:-mx-4">
        <div class="lg:w-1/2 lg:px-4">
          <h3 class="text-xl font-medium text-gray-800 md:text-2xl lg:text-3xl">
            Empowering innovation through cutting-edge technology solutions for a brighter tomorrow.
          </h3>

          <p class="mt-6 text-gray-500">
            At Crytech, we're passionate about harnessing the power of technology to drive
            innovation and transform the way businesses operate. As a leading provider of
            cutting-edge solutions, we specialize in delivering tailored software, hardware, and
            digital services that empower organizations to thrive in today's rapidly evolving
            digital landscape.
          </p>
    ...
    <section class="container px-6 py-8 mx-auto lg:py-16">
      ...
      <div class="mb-8">
        <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl">
          What we <span class="text-blue-500">offer</span>?
        </h1>

        <p class="max-w-2xl mx-auto mt-6 text-center text-gray-500">
          At Crytech, we specialize in simplifying technology and server solutions for businesses.
      ...
      <div class="grid grid-cols-1 gap-8 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
        <div class="p-8 space-y-3 border-2 border-indigo-400 rounded-xl">
          ...
          <h1 class="text-2xl font-semibold text-gray-700 capitalize">
            Speed Optimization Capability
          </h1>

          <p class="text-gray-500">
            We prioritize speed optimization techniques to ensure your website loads blazingly fast,
        ...
        <div class="p-8 space-y-3 border-2 border-indigo-400 rounded-xl">
          ...
          <p class="text-gray-500">
            We create tailored software solutions to fit your unique needs, whether it's a web or
            mobile application, or enterprise software
          </p>
        </div>
        ...
        <div class="p-8 space-y-3 border-2 border-indigo-400 rounded-xl">
          ...
          <p class="text-gray-500">
            Our high-performance computing solutions deliver the computational power and scalability
            needed to tackle complex research challenges.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container px-6 py-10 mx-auto">
        <div class="mt-6 md:flex md:items-center md:justify-between">
          ...
          <div class="flex justify-between mt-8 md:mt-0">
            <button
              title="left arrow"
              class="p-2 mx-3 text-gray-800 transition-colors duration-300 border rounded-full rtl:-scale-x-100 hover:bg-gray-100"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-6 h-6"
        ...
        <section class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
          <div
            class="p-8 border rounded-lg relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2"
          >
            <p class="leading-loose text-gray-500">
              “Overall, Crytech has proven to be a reliable and innovative partner in our journey
              towards digital transformation. Their professional cloud server solutions and website
              development services have played a pivotal role in driving our business growth and
              success. We highly recommend Crytech to any organization seeking top-notch cloud and
              web solutions.”.
            </p>
          ...
          <div
            class="p-8 bg-blue-500 border border-transparent rounded-lg relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2"
          >
            <p class="leading-loose text-white">
              “Crytech's website development team crafted a stunning website that not only reflects
              our brand identity but also captivates our target audience. The website's
              user-friendly interface, coupled with its robust functionality, has significantly
              improved user engagement and conversion rates. We've received numerous compliments
              from clients and partners on the aesthetics and performance of our website, all thanks
              to Crytech's expertise”.
            </p>
          ...
          >
            <p class="leading-loose text-gray-500">
              “Crytech's professional cloud server solutions have provided us with unparalleled
              reliability, scalability, and security. Their team of experts meticulously analyzed
              our requirements and tailored a cloud infrastructure that perfectly aligns with our
              needs. From seamless migration to ongoing support, Crytech's dedication to ensuring
              our server operations run smoothly has been commendable.”.
            </p>
    ...
    <section class="container px-6 py-8 mx-auto lg:py-16">
      <h3 class="text-xl font-medium text-gray-800 md:text-2xl lg:text-3xl">Gallery</h3>
      ...
      <div class="grid grid-cols-1 gap-10 mt-10 md:grid-cols-2 lg:grid-cols-3">
        <a href="#" class="transition-all duration-500 lg:col-span-2 hover:scale-105">
          <img
            ...
            src="https://images.ctfassets.net/3s5io6mnxfqz/5925yJyZW7Acg3oKrKzMMu/f09be95d1b827ad2c3518ccb6504440f/positions-in-a-company.jpeg"
            alt=""
          />
        </a>
        ...
        <a href="#" class="transition-all duration-500 hover:scale-105">
          <img
            class="object-cover object-top w-full rounded-lg shadow-md shadow-gray-200 h-80 xl:h-96"
            src="https://www.livecareer.com/lcapp/uploads/2020/09/ways-you-could-make-a-contribution-to-our-company.jpg"
            alt=""
          />
        </a>
        ...
        <a href="#" class="transition-all duration-500 lg:col-span-2 hover:scale-105">
          <img
            class="object-cover object-top w-full rounded-lg shadow-md shadow-gray-200 h-80 xl:h-96"
            src="https://miro.medium.com/v2/resize:fit:1400/0*riXUOtjXv6JJ9hXo"
            alt=""
          />
        </a>
        ...
        <a href="#" class="transition-all duration-500 lg:col-span-2 hover:scale-105">
          <img
            class="object-cover object-top w-full rounded-lg shadow-md shadow-gray-200 h-80 xl:h-96"
            src="https://content.fortune.com/wp-content/uploads/2016/11/502197407.jpg"
            alt=""
          />
        </a>
    ...
    <section class="container px-6 py-8 mx-auto lg:py-16">
      ...
      <div class="grid grid-cols-1 gap-8 mt-8 md:mt-10 md:grid-cols-2 xl:grid-cols-3">
        <div>
          ...
          <a href="#" class="inline-block mt-4 text-indigo-500 underline hover:text-indigo-400"
            >Read more</a
          >
        </div>
...
<style scoped>
.bgcompany {
  background-image: url('../assets/img/fullsite-img7.jpg');
}
</style>
<script setup></script>
